...
import utilities.RetreiveExcelData;
...
public class LambdaTests {
    ...
    public void test1() throws Exception {
        try {
            ...
            driver.quit();
            System.out.println("Test1 is finalized");
        } catch (Exception e) {
    ...
    public void test2() throws Exception {
        try {
            ...
            driver.quit();
            System.out.println("Test2 is finalized");
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    public void test3() throws Exception {
        try {
            ...
            driver.findElement(By.id("name")).sendKeys("yasin");
            driver.findElement(By.id("inputEmail4")).sendKeys("tahayroguz@gmail.com");
            driver.findElement(By.xpath("//*[@type='password']")).sendKeys("yasin123");
            driver.findElement(By.id("company")).sendKeys("yasin");
            driver.findElement(By.id("websitename")).sendKeys("yasin.com");
            Select country = new Select(driver.findElement(By.name("country")));
            country.selectByVisibleText("United States");

            driver.findElement(By.id("inputCity")).sendKeys("miami");
            driver.findElement(By.id("inputAddress1")).sendKeys("big street");
            driver.findElement(By.id("inputAddress2")).sendKeys("high road");
            driver.findElement(By.id("inputState")).sendKeys("florida");
            driver.findElement(By.id("inputZip")).sendKeys("343453");
            ...
            driver.quit();
            System.out.println("Test3 is finalized");
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    }
